...
if (args.length < 3) {
    println "Usage: groovy TextReplacerClass.groovy <directoryPath> <searchText> <replaceText> [<logFilePath>]"
    System.exit(1)
}
...
println "Creating TextReplacerClass instance..."
TextReplacerClass replacer = new TextReplacerClass(directoryPath, searchText, replaceText, logFilePath)
